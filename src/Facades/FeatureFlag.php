 ...
 * @method static ?\Chemaclass\FeatureFlags\DTO\VariantResult variant(FeatureKey|string $flag, ?string $scopeId = null, array<string, mixed> $context = [])
 * @method static void defineSegment(string $name, array<int, array<string, mixed>> $conditions, ?string $description = null)
 * @method static bool deleteSegment(string $name)
 * @method static array<string, array<int, array<string, mixed>>> segments()
